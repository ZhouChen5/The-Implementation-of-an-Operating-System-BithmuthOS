...
use drivers::mouse::{MOUSE, MOUSE_INT, mouse};
...
pub extern "C" fn _start() -> ! {
    unsafe {
        ...
        PRINTER.prints("[INFO] Initializing Mouse...\n");
        MOUSE.init();
        IDT.add(MOUSE_INT as usize, mouse as u32);
...
fn panic(info: &PanicInfo) -> ! {
    ...
    lib::println!();
    lib::println!("  ========== BismuthOS v1.0 ==========");
    lib::println!();
    lib::println!("  KERNEL PANIC!");
    lib::println!();
    lib::println!("  BismuthOS has encountered a panic and the system has been halted.");
    lib::println!();
    lib::println!();
    lib::println!();
    lib::println!();
...
fn print_info() {
    ...
    lib::println!();
    lib::println!("  Welcome to BismuthOS v1.0!");
    lib::println!("  MIT License - Copyright (c) 2025");
    lib::println!();
